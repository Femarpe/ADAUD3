...
public class App {
        ...
        do {
            ...
            if (usuarios.get(dc.posUser).getPassword().equals(entPassw)) {
                ...
                System.out.println("la contraseña introducida no es valida para el usuario: " +
                        usuarios.get(dc.posUser).getUsername() + " con el id: " + entIdUser);
            }
    ...
    public void editarFicha(List<Ficha> fichasPorUsuario, FichaAccessDB fichaAccessDB, App app) throws SQLException {
    ...
    public void crearFicha(List<Ficha> fichas, App app,
    ...
    public void mostrarFicha(List<Ficha> fichasPorUsuario, FichaAccessDB fichaAccessDB, App app) {
                ...
                do {
                    ...
                    if (nombre.equals("")) {
                        ...
                        for (int i = 0; i < usuarios.size(); i++) {
                            if (usuarios.get(i).getUsername().toLowerCase().equals(nombre.toLowerCase())) {
                                nombreExiste = true;
                            }
                        }
    ...
    public void mostrarUsusarios(List<Login> usuarios) {
        for (int i = 0; i < usuarios.size(); i++) {
            System.out.println("Id-" + usuarios.get(i).getId() + " Nombre-" + usuarios.get(i).getUsername());
        }
    }
        ...
        do {
            ...
            if (loginAccessDB.idInside(idUsuAborrar,usuarios)){
                ...
                System.out.println("para borrar el usuario "+
                        usuarios.get(pos).getUsername()+ " con id: "+
                ...
                if (usuarios.get(pos).getPassword().equals(entPassw) || usuarios.get(0).getPassword().equals(entPassw)) {
                    ...
                    System.out.println("la contraseña introducida no es valida para el usuario: " +
                            usuarios.get(pos).getUsername() + " con el id: " + idUsuAborrar);
                }
